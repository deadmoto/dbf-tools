...
namespace CheckDBF
{
    ...
    {
        /// <summary>
        /// Provides dBase connection
        /// </summary>
        public static OdbcCommand dBaseCommand(string CommandText = "", string SourceDB = "")
        {
            ...
            ConnectionStringBuilder.Driver = "Microsoft dBASE Driver (*.dbf)";
            ConnectionStringBuilder.Add("DataSource", "dBase Files");
            ConnectionStringBuilder.Add("SourceDB", SourceDB);
